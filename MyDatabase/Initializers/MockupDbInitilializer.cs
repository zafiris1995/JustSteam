...
namespace MyDatabase.Initializers
{
    internal class MockupDbInitilializer : DropCreateDatabaseAlways<ApplicationDbContext>
    {
        ...
        {
            #region Game Seeding
            Game g1 = new Game() { Title = "Fifa 23", Price = 10, Rating = 10, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/a/a6/FIFA_23_Cover.jpg" };
            Game g2 = new Game() { Title = "The Legend of Zelda", Price = 5, Rating = 3, PhotoUrl = "https://upload.wikimedia.org/wikipedia/el/d/d0/Zelda_Cover_Europe.jpg" };
            Game g3 = new Game() { Title = "Tetris", Price = 3, Rating = 6, PhotoUrl = "https://upload.wikimedia.org/wikipedia/el/8/8d/NES_Tetris_Box_Front.jpg" };
            Game g4 = new Game() { Title = "Starcraft", Price = 10, Rating = 9, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/9/93/StarCraft_box_art.jpg" };
            Game g5 = new Game() { Title = "Diablo", Price = 5, Rating = 5, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/3/3a/Diablo_Coverart.png" };
            Game g6 = new Game() { Title = "Mass Effect", Price = 20, Rating = 5, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/e/e8/MassEffect.jpg" };
            Game g7 = new Game() { Title = "Dragon Age: Origins", Price = 10, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/8/89/Dragon_Age_Origins_cover.png" };
            Game g8 = new Game() { Title = "Half-Life", Price = 70, Rating = 1, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/f/fa/Half-Life_Cover_Art.jpg" };
            Game g9 = new Game() { Title = "Age of Empires II", Price = 15, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/5/56/Age_of_Empires_II_-_The_Age_of_Kings_Coverart.png" };
            Game g10 = new Game() { Title = "Starcraft II", Price = 20, Rating = 4, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/2/20/StarCraft_II_-_Box_Art.jpg" };
            Game g11 = new Game() { Title = "Diablo II", Price = 10, Rating = 5, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/d/d5/Diablo_II_Coverart.png" };
            Game g12 = new Game() { Title = "Pathfinder: Kingmaker", Price = 30, Rating = 3, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/e/e6/Pathfinder_Kingmaker_cover_art.jpg" };
            Game g13 = new Game() { Title = "Oxygen Not Included", Price = 25, Rating = 8, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/f/f6/Oxygen_Not_Included_cover_art.jpg" };
            Game g14 = new Game() { Title = "Minecraft", Price = 30, Rating = 8, PhotoUrl = "https://upload.wikimedia.org/wikipedia/el/8/82/Minecraft_cover.jpg" };
            Game g15 = new Game() { Title = "Diablo III", Price = 15, Rating = 4, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/8/80/Diablo_III_cover.png" };
            Game g16 = new Game() { Title = "Cities: Skylines", Price = 20, Rating = 6, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/5/58/Cities_Skylines_cover_art.jpg" };
            Game g17 = new Game() { Title = "Final Fantasy VII", Price = 7, Rating = 3, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/c/c2/Final_Fantasy_VII_Box_Art.jpg" };
            Game g18 = new Game() { Title = "Resident Evil", Price = 9, Rating = 4, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/a/a6/Resident_Evil_1_cover.png" };
            Game g19 = new Game() { Title = "The Secret of Monkey Island", Price = 15, Rating = 10, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/a/a8/The_Secret_of_Monkey_Island_artwork.jpg" };
            Game g20 = new Game() { Title = "DotA 2", Price = 60, Rating = 5, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/0/0b/Dota_2_%28Steam_2019%29.jpg" };
            Game g21 = new Game() { Title = "MultiVersus", Price = 50, Rating = 7, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/1/1d/MultiVersus_Cover_Art.png" };
            Game g22 = new Game() { Title = "Fallout", Price = 30, Rating = 9, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/a/af/Fallout.jpg?20210820180451" };
            Game g23 = new Game() { Title = "League of Legends", Rating = 6, Price = 0, PhotoUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/League_of_Legends_2019_vector.svg/900px-League_of_Legends_2019_vector.svg.png" };
            Game g24 = new Game() { Title = "Far Cry", Price = 15, Rating = 9, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/a/a5/Far_Cry_1_boxshot.jpg" };
            Game g25 = new Game() { Title = "Sonic the Hedgehog", Rating = 4, Price = 8, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/b/ba/Sonic_the_Hedgehog_1_Genesis_box_art.jpg?20150330215349" };
            Game g26 = new Game() { Title = "World of Warcraft", Rating = 6, Price = 18, PhotoUrl = "https://upload.wikimedia.org/wikipedia/en/6/65/World_of_Warcraft.png" };
